...
class BirdsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bird" do
    assert_difference('Bird.count') do
      post birds_url, params: { bird: { birder: @bird.birder, date: @bird.date, image_url: @bird.image_url, location: @bird.location, species: @bird.species } }
    end
  ...
  test "should update bird" do
    patch bird_url(@bird), params: { bird: { birder: @bird.birder, date: @bird.date, image_url: @bird.image_url, location: @bird.location, species: @bird.species } }
